...
*  Excel: Power Query for data cleaning, Pivot Tables for initial discovery.
*  Power BI: DAX for complex measures
*  Key Skills: ETL (Extract, Transform, Load), Data Auditing, and Trend Analysis.

## Data Dictionary
*  Order Priority: Used to analyze the cost-to-speed trade-off.
*  Shipping Cost & Mode: Key variables for logistics optimization.
*  Customer Segment: Used for targeted demographic insights.
*  Returned Orders: Used to evaluate the impact of returned orders on the profitability.
 ...
 *  The examination shows High Dependency on Tech & Office Supplies
 *  Temporal Trends (Weekly/Monthly)-There is a massive spike in profit on Fridays ($0.29M) compared to the rest of the week, and January/October seem to be peak months.
